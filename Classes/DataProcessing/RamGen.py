...
class RamGen(Sequence):
    def __init__(self, traces, labels, batch_size, noiseAug, num_channels, norm_scale = False, shuffle=True, label_dict = None):
        self.traces = traces
        self.labels = labels
    ...
    def __transform_labels(self, labels):
        ...
        lab = lab[:,1]
        transformed_labels = np.reshape(lab, (lab.shape[0], 1))
