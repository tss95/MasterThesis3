...
from Classes.Modeling.LocalOptimizerDynamic import LocalOptimizerDynamic
...
result_file_name = 'results_CNN_noiseNotNoise_timeAug_noiseAug_earlyS_numChannels-3.csv'
quick_mode = False
...
narrowOpt = LocalOptimizerDynamic(loadData = loadData, 
